...
## Flow
1. **Countdown page** — dark blue/black sparkling night sky, live countdown to the date you set. The sky gets a warm glow and more shooting stars in the final hour. The "enter" button stays locked until the countdown hits zero.
2. **Letter page** — vintage parchment styling, your personal message, paragraphs fade in as you scroll.
3. **Cake page** — tap once to blow out the candle (a wisp of smoke rises), tap again to cut the cake.
4. **Surprise page** — `freefire-bg.jpg` / `freefire-bg-mobile.jpg` as a full-bleed animated "live wallpaper" background with a subtle parallax, a "Click for Surprise" button, and a text link, both pointing to the official Free Fire site.
